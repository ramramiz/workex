    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
        <div>
            ...
            <p class="dash-hero-subtitle mt-1">
                Manage your team and projects — {{ now()->format('l, d F Y') }}
            </p>

            <div class="d-flex align-items-center gap-3 mt-3 flex-wrap">
                <div class="d-flex align-items-center gap-2 text-white" style="font-size:13px;">
                    <span class="status-dot-live"></span>
                    <span><strong class="text-success">{{ $stats['working_today'] }}</strong> <span style="color:#94a3b8">team members active right now</span></span>
                </div>
...
<div class="row g-3 mb-4">
    ...
    <div class="col-6 col-sm-6 col-lg-3">
        <div class="kpi-card">
            ...
            <div class="kpi-value" style="color:var(--text-primary);">{{ $stats['team_members'] }}</div>
    ...
    <div class="col-6 col-sm-6 col-lg-3">
        <div class="kpi-card">
            ...
            <div class="kpi-value" style="color:var(--text-primary);">{{ $stats['my_projects'] }}</div>
    ...
    <div class="col-6 col-sm-6 col-lg-3">
        <div class="kpi-card">
            ...
            <div class="kpi-sub" style="color:#16a34a;">
                <i class="bi bi-check2-all"></i> {{ $stats['completed_tasks_today'] }} completed today
            </div>
        </div>
    </div>
        ...
        <div class="dash-section-card">
            <div class="dash-section-header">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <span>My Projects &amp; Progress Updates</span>
            ...
            <div class="p-3">
                ...
                @if($myProjects->isEmpty())
                    <div class="text-center py-4" style="color:var(--text-secondary);">
                        ...
                        <div style="font-size:12px;color:#94a3b8;margin-top:4px;">No active projects led by you</div>
                    </div>
                @else
                    <div class="row g-3">
                        @foreach($myProjects->take(8) as $project)
                        @php
                            $sc = $statusColors[$project->status] ?? ['bg'=>'rgba(100,116,139,0.12)','color'=>'#64748b','label'=>$project->status_label];
        ...
        <div class="dash-section-card h-100">
            <div class="dash-section-header">
                <div class="d-flex align-items-center">
                    ...
                    <span>Team Live Work Status</span>
            ...
            <div style="max-height: 420px; overflow-y: auto;">
                ...
                <div class="live-row">
                    <div class="position-relative flex-shrink-0">
                        ...
                        @if($session->timeLogs && $session->timeLogs->isNotEmpty())
                ...
                <div class="text-center py-5" style="color:var(--text-secondary);">
                    ...
                    <div style="font-size:14px;font-weight:600;">No team members working right now</div>
        ...
        <div class="dash-section-card mb-4">
            <div class="dash-section-header">
                <div class="d-flex align-items-center">
                    ...
                    <span>Team Leaves &amp; Reports Pending</span>
                </div>
            </div>
            
            <div class="p-3">
                <h6 class="fw-bold mb-2 fs-7" style="color:var(--text-secondary);">Leaves Pending Review</h6>
                @forelse($pendingLeaves as $leave)
                <div class="d-flex align-items-center gap-3 py-2 border-bottom">
                    <img src="{{ $leave->user->avatar_url }}" class="rounded-circle" width="32" height="32" style="object-fit: cover;">
                    <div class="flex-grow-1 min-w-0">
                        <div class="fw-semibold text-truncate" style="font-size:13px;">{{ $leave->user->name }}</div>
                        <div class="text-muted" style="font-size:11.5px;">{{ $leave->from_date->format('d M') }} - {{ $leave->to_date->format('d M') }}</div>
                    </div>
                    <a href="{{ route('leaves.index', ['status' => 'pending']) }}" class="btn btn-xs btn-outline-primary py-1 px-2" style="font-size:11px;">Review</a>
                </div>
                @empty
                <div class="text-muted text-center py-2 fs-8">No pending leaves</div>
                @endforelse

                <h6 class="fw-bold mt-3 mb-2 fs-7" style="color:var(--text-secondary);">Reports Pending Review</h6>
                @forelse($pendingReports as $report)
                <div class="d-flex align-items-center gap-3 py-2 border-bottom">
                    <img src="{{ $report->user->avatar_url }}" class="rounded-circle" width="32" height="32" style="object-fit: cover;">
                    <div class="flex-grow-1 min-w-0">
                        <div class="fw-semibold text-truncate" style="font-size:13px;">{{ $report->user->name }}</div>
                        <div class="text-muted" style="font-size:11.5px;">Report for {{ $report->date->format('d M Y') }}</div>
                    </div>
                    <a href="{{ route('daily-reports.show', $report) }}" class="btn btn-xs btn-outline-primary py-1 px-2" style="font-size:11px;">Review</a>
                </div>
                @empty
                <div class="text-muted text-center py-2 fs-8">No pending reports</div>
                @endforelse
            </div>
        </div>
        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 16px;">
            <div class="modal-header border-bottom-0 pb-3" style="background:linear-gradient(135deg,#0f172a,#1e1b4b); color: #fff;">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 class="modal-title fw-bold mb-0" id="currentWorksUpdateModalLabel" style="color:#fff;">Team Works Update</h5>
                ...
                <div class="row g-3">
                    ...
                    @empty
                        <div class="col-12 text-center py-5 text-muted">
                            ...
                            <p class="mt-2 mb-0">No team members registered in the system.</p>
                        </div>
                    @endforelse
                </div>
            </div>
...
<div class="modal fade" id="checkProjectsModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
