                ...
                <form method="POST" action="{{ route('employees.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="email" name="personal_email" class="form-control @error('personal_email') is-invalid @enderror" value="{{ old('personal_email') }}" placeholder="e.g. john.personal@gmail.com">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="url" name="google_drive_link" class="form-control @error('google_drive_link') is-invalid @enderror" value="{{ old('google_drive_link') }}" placeholder="https://drive.google.com/drive/folders/...">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <select name="is_applicable_for_salary" class="form-select @error('is_applicable_for_salary') is-invalid @enderror" required>
                                <option value="1" {{ old('is_applicable_for_salary', 1) == 1 ? 'selected' : '' }}>Yes</option>
                                <option value="0" {{ old('is_applicable_for_salary', 1) == 0 ? 'selected' : '' }}>No</option>
                            </select>
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <select name="show_in_live_status" class="form-select @error('show_in_live_status') is-invalid @enderror" required>
                                <option value="1" {{ old('show_in_live_status', 1) == 1 ? 'selected' : '' }}>Yes</option>
                                <option value="0" {{ old('show_in_live_status', 1) == 0 ? 'selected' : '' }}>No</option>
                            </select>
...
<script>
    ...
    function updateSingleDaySalary() {
        ...
        const salaryType = salaryTypeSelect ? salaryTypeSelect.value : 'monthly';
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (salaryInput) {
            ...
            if (salaryTypeSelect) {
                salaryTypeSelect.addEventListener('change', updateSingleDaySalary);
            }
