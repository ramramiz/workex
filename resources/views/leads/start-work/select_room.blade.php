...
<div class="row justify-content-center">
    <div class="col-12 col-md-10">
        ...
        <div class="row g-4">
            <!-- Virtual Room Card for Today's Follow-ups -->
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card h-100 border shadow-sm hover-shadow-sm transition-all" style="border-radius: 16px; border-color: #ef4444 !important; transition: transform 0.2s, box-shadow 0.2s;">
                    <div class="card-body p-4 d-flex flex-direction-column justify-content-between" style="height: 100%; display: flex; flex-direction: column;">
                        <div>
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="bg-danger-subtle text-danger rounded-circle d-flex align-items-center justify-content-center" style="width: 48px; height: 48px; min-width: 48px;">
                                    <i class="bi bi-bell-fill fs-4 animate-pulse"></i>
                                </div>
                                <div>
                                    <h5 class="fw-bold text-dark mb-0">Today's Follow-ups</h5>
                                    <span class="badge bg-danger text-white mt-1">{{ count($todayFollowUps) }} Scheduled</span>
                                </div>
                            </div>
                            <p class="text-secondary fs-7.5 mb-4">Dedicated room to handle all your scheduled follow-up leads across all assigned rooms for today.</p>
                        </div>
                        <div class="mt-auto">
                            <a href="{{ route('leads.start-work.select-followups') }}" class="btn btn-danger w-100 fw-bold d-flex align-items-center justify-content-center gap-2 py-2 text-white" style="border-radius: 10px;">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card h-100 border shadow-sm hover-shadow-sm transition-all" style="border-radius: 16px; transition: transform 0.2s, box-shadow 0.2s;">
                        <div class="card-body p-4 d-flex flex-direction-column justify-content-between" style="height: 100%; display: flex; flex-direction: column;">
                            ...
                            <div class="mt-auto">
                                <a href="{{ route('leads.start-work.select-room-join', $room) }}" class="btn btn-warning w-100 fw-bold d-flex align-items-center justify-content-center gap-2 py-2 text-dark" style="border-radius: 10px;">
                                    Select Room <i class="bi bi-arrow-right-short"></i>
                                </a>
                            </div>
                        </div>
