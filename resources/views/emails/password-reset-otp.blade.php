    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px; background-color: #1e293b; border-radius: 16px; border: 1px solid rgba(255,255,255,0.06); box-shadow: 0 10px 25px -5px rgba(0,0,0,0.3); overflow: hidden;">
        ...
        <tr>
            <td style="padding: 40px 40px 20px 40px; text-align: center;">
                ...
                <p style="font-size: 13px; color: #94a3b8; margin: 6px 0 0 0;">WorkeX Secure Password Reset</p>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding: 30px 40px;">
                <p style="font-size: 15px; line-height: 1.6; color: #cbd5e1; margin-top: 0;">We received a request to update your password. Please use the following secure verification code to proceed:</p>
                ...
                <p style="font-size: 14px; line-height: 1.5; color: #94a3b8;">This code is valid for **10 minutes**. If you did not request a password reset, please ignore this email or contact support.</p>
            </td>
        </tr>
