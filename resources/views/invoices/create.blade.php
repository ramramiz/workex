    ...
    <div class="col-12 col-lg-10 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Generate Customer Invoice</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('invoices.store') }}" id="invoiceForm">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" name="invoice_number" class="form-control fw-semibold" value="{{ old('invoice_number', $number) }}" required readonly>
                        </div>
                        <div class="col-12 col-md-4">
                    ...
                    <div class="mb-4">
                        <textarea name="notes" class="form-control" rows="3" placeholder="Specify wire transfer details, banking credentials, or due notes...">{{ old('notes', "Please pay within 15 days of invoice date.\nBank: State Bank of India\nAccount: 12345678901\nIFSC: SBIN0001234") }}</textarea>
                    </div>
