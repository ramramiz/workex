                ...
                <form method="POST" action="{{ route('clients.store') }}">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="contact_person" class="form-control @error('contact_person') is-invalid @enderror" value="{{ old('contact_person') }}" required placeholder="e.g. Robert Smith">
