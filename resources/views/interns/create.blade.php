...
@section('title', 'Register Intern')
@section('page-title', 'Register Intern')
    ...
    <div class="col-12 col-lg-10 mx-auto">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white py-3">
                <h5 class="mb-0 fw-bold text-dark">Register New Intern</h5>
            </div>
                ...
                <form method="POST" action="{{ route('interns.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" required placeholder="e.g. john@domain.com">
                            @error('email')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label fw-medium">Phone Number</label>
                            <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') }}" placeholder="e.g. +91 98765 43210">
                            @error('phone')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label fw-medium">Intern Photo</label>
                            <input type="file" name="photo" class="form-control @error('photo') is-invalid @enderror" accept="image/*">
                            <div class="form-text fs-8 text-muted" style="font-size: 11px;">Supported formats: JPEG, PNG. Max: 2MB.</div>
                    ...
                    <div class="d-flex align-items-center justify-content-end gap-2 border-top pt-3">
                        ...
                        <button type="submit" class="btn btn-primary px-4">Register Intern</button>
                    </div>
                </form>
            </div>
        </div>
