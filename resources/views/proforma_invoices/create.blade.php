    ...
    <div class="col-12 col-lg-10 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Generate Customer Proforma Invoice</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('proforma-invoices.store') }}" id="proformaForm">
                    @csrf
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" name="proforma_number" class="form-control fw-semibold" value="{{ old('proforma_number', $number) }}" required readonly>
                        </div>
                        <div class="col-12 col-md-4">
                            <label class="form-label">Proforma Date <span class="text-danger">*</span></label>
                            <input type="date" name="proforma_date" class="form-control @error('proforma_date') is-invalid @enderror" value="{{ old('proforma_date', date('Y-m-d')) }}" required>
                    ...
                    <div class="table-responsive mb-3">
                        <table class="table table-bordered align-middle" id="itemsTable">
                            ...
                            <tbody id="itemsContainer">
                                <tr>
                                    <td>
                                        <input type="text" name="items[0][name]" class="form-control form-control-sm" required placeholder="e.g. Phase 1 Deliverables">
                                    </td>
                                    <td>
                        ...
                        <div class="col-12 col-md-5">
                            <div class="card bg-light p-3">
                                ...
                                <div class="mb-2 row align-items-center">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="number" step="0.1" name="tax_percentage" id="tax_percentage" class="form-control form-control-sm" value="{{ $tax }}" oninput="calculateTotals()">
                                    </div>
                                </div>
                                <div class="mb-2 row align-items-center">
                                    <label class="col-sm-5 col-form-label col-form-label-sm fw-medium">GST Amount (₹)</label>
                                    <div class="col-sm-7">
                                        <input type="number" step="0.01" name="tax_amount" id="tax_amount" class="form-control form-control-sm" value="0.00" readonly>
                                    </div>
                                </div>
                                <hr class="my-2">
                    ...
                    <div class="mb-4">
                        <textarea name="notes" class="form-control" rows="3" placeholder="Specify wire transfer details, banking credentials, or due notes...">{{ old('notes', "This is a Proforma Invoice, which is a preliminary bill sent before the actual delivery of products or services.\nBank: State Bank of India\nAccount: 12345678901\nIFSC: SBIN0001234") }}</textarea>
                    </div>

                    <div class="d-flex align-items-center justify-content-end gap-2 border-top pt-3">
                        <a href="{{ route('proforma-invoices.index') }}" class="btn btn-outline-secondary">Cancel</a>
